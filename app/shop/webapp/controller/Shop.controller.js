sap.ui.define([
    ...
    function (Controller, Filter, FilterOperator, Sorter) {
        ...
        return Controller.extend("com.shop.shop.controller.Shop", {
            onInit: function () {
                this.oRouter = this.getOwnerComponent().getRouter();
                this.getOwnerComponent().getRouter().getRoute("RouteShop").attachPatternMatched(this._onMasterMatch, this);
            },
            ...
            onNavigate: function(oEvent){
                ...
                this.oRouter.navTo("Detail",{
                   categorisId: Item.getBindingContext().getObject().ID,
